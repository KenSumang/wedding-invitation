  ...
  return (
    <section className="w-full bg-[#eeece8] px-0 md:px-4">
      ...
      >
        ...
        ========================= */}
        <div className="flex w-full flex-col px-8 pb-[20px] sm:px-10 md:w-[50%] md:px-12 md:my-[20px] lg:px-12 ">
          <div className="">
            <div className="details-a flex flex-col mx-auto gap-8 mb-10 ml-[7px] md:justify-between md:items-start md:mx-0">
                <p className="hidden uppercase text-subtitle tracking-[0.28em] text-subtitle-color uppercase md:block">Church</p>

                <div className="line hidden w-9 h-[.5px] bg-[#BDBDBD] md:block md:ml-1"></div>

                <h2 className="hidden uppercase text-start text-title max-w-95 text-title-color tracking-[0.18em] md:block lg:max-w-2/3">San Juan Nepomuceno<br />Parish Church</h2>

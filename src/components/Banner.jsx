...
function Banner() {
    ...
    useEffect(() => {
        ...
        // Set the correct initial value immediately
        handleScroll();
            ...
            <div className="container relative z-10 max-w-full h-full px-4 sm:px-6 md:px-10 2xl:px-18 max-w-380">
                <div className="wrapper w-full h-full flex flex-col md:items-start md:justify-center">
                    ...
                    <div className="flex flex-col items-center gap-2.5 mt-auto mb-7 sm:gap-4 md:mt-14 md:items-start xl:gap-9">
                        ...
                        <p className="subtitle tracking-[.28em] text-banner-subtitle text-white">
                            TOGETHER FOREVER
                        </p>
                        ...
                        <div className="banner-title flex flex-col gap-[2px] items-center mb-1 sm:gap-1.5 md:gap-4 lg:gap-8 md:items-start 2xl:flex-row transition-all duration-200">
                            <h2 className="font-light tracking-[.18em] text-banner-heading leading-12 text-white">
                                ARMAND
                            </h2>

                            <p className="font-light leading-12 text-white text-banner-ampersand">
                                &
                            </p>

                            <h2 className="font-light tracking-[.18em] text-banner-heading leading-12 text-white mb-3 xl:mb-0">
                                EDELYN
                            </h2>
                        ...
                        <p className="date tracking-[.16em] text-date text-white mb-2">
                            January 15, 2027
                        </p>

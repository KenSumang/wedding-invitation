...
// import bannerSm from '../assets/A&E_banner_sm.avif';
// import bannerLg from '../assets/A&E_banner_lg.avif';
...
//         <section
//             id="banner"
//             className={`banner w-full h-svh bg-[55%_120%] bg-[length:auto_120%] xs:bg-[length:auto_130%] xs:bg-[55%_90%] sm:h-dvh sm:bg-[length:auto_158%] sm:bg-position-[center_67%] md:bg-[length:auto_140%] md:bg-[55%_80%] transition-[background-position,background-size] duration-300`}
//             style={{
//                 backgroundImage: `url(${bannerSm})`,
//             }}
//         >
//             {/* md+ background swapped via a scoped style tag keeps the same "two art-directed images" behavior without inline url() strings */}
//             <style>{`
//                 @media (min-width: 768px) {
//                     #banner { background-image: url(${bannerLg}); }
//                 }
//             `}</style>

//             <div aria-hidden="true" className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent via-60% to-black z-0"></div>

//             <div className="container relative z-10 h-full px-4 sm:px-6 md:px-10 2xl:px-18 max-w-380">
//                 <div className="wrapper w-full h-full flex flex-col md:items-start md:justify-center">
...
//                         <div className="banner-title flex flex-col gap-[3px] items-center text-[44px] mb-1 sm:gap-1.5 sm:text-[50px] md:text-[58px] 2xl:text-[74px] md:gap-8 md:items-start 2xl:flex-row transition-[gap] duration-200">
//                             <h2 className="font-light tracking-widest leading-12 text-white">ARMAND</h2>
//                             <p className="text-[38px] font-light leading-12 text-white sm:text-[40px] md:pr-2 md:text-[64px]">&</p>
//                             <h2 className="font-light tracking-widest leading-12 text-white mb-3 xl:mb-0">EDELYN</h2>
//                             <div className="line w-12 h-[.4px] bg-white md:hidden"></div>

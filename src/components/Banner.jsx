...
function Banner() {
    return (
        <section id="banner" className="banner w-full h-dvh bg-[url('./src/assets/A&E_banner_sm.avif')] md:bg-[url('./src/assets/A&E_banner_lg.avif')] bg-[55%_120%] bg-[length:auto_120%] sm:bg-[length:auto_140%] sm:bg-[55%_80%]">
            ...
            <div className="container relative z-10 max-w-full h-full px-4 sm:px-6 md:px-10 2xl:px-18 max-w-380">
                <div className="wrapper w-full h-full flex flex-col md:items-start md:justify-center">
                    ...
                    <div className="flex flex-col items-center gap-5 mt-auto mb-20 md:mt-14 md:items-start xl:gap-9">
                        ...
                        <p className="subtitle text-[14px] tracking-widest text-white md:text-[16px] 2xl:text-[18px]">TOGETHER FOREVER</p>

                        <div className="banner-title flex flex-col gap-1.5 items-center text-[50px] mb-1 md:text-[58px] 2xl:text-[74px] md:gap-8 md:items-start 2xl:flex-row">
                        ...
                        <p className="date text-[18px] tracking-widest text-white md:text-[20px] 2xl:text-[22px]">JANUARY 15, 2027</p>
                    </div>

...
function Banner() {
    return (
        <section id="banner" className="banner w-full h-svh bg-[url('./src/assets/A&E_banner_sm.avif')] md:bg-[url('./src/assets/A&E_banner_lg.avif')] bg-[55%_120%] bg-[length:auto_120%] xs:bg-[length:auto_130%] xs:bg-[55%_90%] sm:h-dvh sm:bg-[length:auto_158%] sm:bg-position-[center_67%] md:bg-[length:auto_140%] md:bg-[55%_80%]">
            ...
            <div className="container relative z-10 max-w-full h-full px-4 sm:px-6 md:px-10 2xl:px-18 max-w-380">
                <div className="wrapper w-full h-full flex flex-col md:items-start md:justify-center">
                    ...
                    <div className="flex flex-col items-center gap-2.5 mt-auto mb-15 sm:mb-20 sm:gap-5 md:mt-14 md:items-start xl:gap-9">
                        ...
                        <div className="banner-title flex flex-col gap-[3px] items-center text-[44px] mb-1 sm:gap-1.5 sm:text-[50px] md:text-[58px] 2xl:text-[74px] md:gap-8 md:items-start 2xl:flex-row">
